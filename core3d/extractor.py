...
class BasicEncoder(nn.Module):
    def __init__(self, output_dim=128, norm_fn='batch', dropout=0.0):
        ...
        # self.conv1 = nn.Conv3d(3, 64, kernel_size=7, stride=2, padding=3) # 这里的3为input——channels
        self.conv1 = nn.Conv3d(1, 64, kernel_size=7, stride=2, padding=3)  # 这里的1 为input——channels
