...
class SepConvGRU(nn.Module):
    def __init__(self, hidden_dim=128, input_dim=192+128):
        ...
        self.convz1 = nn.Conv3d(hidden_dim+input_dim, hidden_dim, (1,5), padding=(0,2))
        self.convr1 = nn.Conv3d(hidden_dim+input_dim, hidden_dim, (1,5), padding=(0,2))
        self.convq1 = nn.Conv3d(hidden_dim+input_dim, hidden_dim, (1,5), padding=(0,2))

        self.convz2 = nn.Conv3d(hidden_dim+input_dim, hidden_dim, (5,1), padding=(2,0))
        self.convr2 = nn.Conv3d(hidden_dim+input_dim, hidden_dim, (5,1), padding=(2,0))
        self.convq2 = nn.Conv3d(hidden_dim+input_dim, hidden_dim, (5,1), padding=(2,0))
...
class SmallMotionEncoder(nn.Module):
    def __init__(self, args):
        ...
        self.convf1 = nn.Conv3d(2, 64, 7, padding=3)
...
class BasicUpdateBlock(nn.Module):
    def __init__(self, args, hidden_dim=128, input_dim=128):
        ...
        self.mask = nn.Sequential(
            ...
            nn.Conv3d(256, 64*9, 1, padding=0))
